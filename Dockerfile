...
RUN groupadd -r gitlab-runner && useradd --disabled-password -r -g gitlab-runner gitlab-runner && mkdir -p /home/gitlab-runner && chown gitlab-runner:gitlab-runner /home/gitlab-runner
USER gitlab-runner
